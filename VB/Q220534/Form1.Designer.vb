...
'			Me.treeList.NodeCellStyle += New DevExpress.XtraTreeList.GetCustomNodeCellStyleEventHandler(Me.OnTreeListNodeCellStyle);
'			Me.treeList.CustomDrawNodeIndent += New DevExpress.XtraTreeList.CustomDrawNodeIndentEventHandler(Me.OnTreeListCustomDrawNodeIndent);
			' 
			' treeListColumn1
			' 
